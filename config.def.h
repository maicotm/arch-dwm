...
//  { MODKEY,                       XK_m,               spawn,          SHCMD("st -e ncmpcpp") },
    ...
    { MODKEY,                       XK_F11,             spawn,          SHCMD("mpv --no-cache --no-audio --no-osc --no-input-default-bindings --input-conf=/dev/null --title=webcam $(ls /dev/video[0,2,4,6,8] | tail -n 1)") },
    { MODKEY|ShiftMask,             XK_F11,             spawn,          SHCMD("mpv --no-cache --no-audio --no-osc --no-input-default-bindings --input-conf=/dev/null --title=Microscope /dev/video2") },
//  { MODKEY|ShiftMask,             XK_F11,             spawn,          SHCMD("mpv av://v4l2:/dev/video2 --profile=low-latency --untimed --no-cahe --no-audio --title=Microscope ") },
